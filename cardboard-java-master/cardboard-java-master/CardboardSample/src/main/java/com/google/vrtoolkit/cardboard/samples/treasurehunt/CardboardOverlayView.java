 ...
 */
public class CardboardOverlayView extends LinearLayout { //child class of the Linear Layout
    private static final String TAG = CardboardOverlayView.class.getSimpleName();
    private final CardboardOverlayEyeView mLeftView; //mLeft is a variable for the class cardboardOverLayEe
    private final CardboardOverlayEyeView mRightView;
    private AlphaAnimation mTextFadeAnimation; //so is TextfadeAnimation
    ...
    public CardboardOverlayView(Context context, AttributeSet attrs) {
        ...
        //This iis the first part where some of the website rendering should go
    ...
    public void show3DToast(String message) {
        message = "come here";
        //minor change made here for observation. remove the declarartion of message afterward
        setText(message);
        setTextAlpha(1f);
